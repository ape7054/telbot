...
class StabbleWeightedSwap {
  ...
  async swapBuy(
    ...
    if (!inputAccountInfo) {
      transaction.add(
        createAssociatedTokenAccountIdempotentInstruction(owner, userTokenIn, owner, input)
      );
    }
    ...
    if (!outputAccountInfo) {
      transaction.add(
        createAssociatedTokenAccountIdempotentInstruction(owner, userTokenOut, owner, output)
      );
    }
