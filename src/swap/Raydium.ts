...
class RaydiumSwap {
  ...
  async swapBuy(
    ...
    if (!inputAccountInfo) {
      ...
      transaction.add(
        createAssociatedTokenAccountIdempotentInstruction(owner, inputTokenAccount, owner, input)
      );
    }
    ...
    if (!outputAccountInfo) {
      ...
      transaction.add(
        createAssociatedTokenAccountIdempotentInstruction(owner, outputTokenAccount, owner, output)
      );
    }
