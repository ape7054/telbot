export const IDL: any = {
  ...
  types: [
    ...
    { name: 'Side', type: { kind: 'enum', variants: [{ name: 'Bid' }, { name: 'Ask' }] } },
    {
      ...
      type: {
        ...
        variants: [
          ...
          { name: 'Cykura' },
          {
            fields: [{ name: 'side', type: { defined: { generics: [], name: 'Side' } } }],
            name: 'Serum',
          },
          ...
          { name: 'RaydiumCP' },
          {
            fields: [
              { name: 'a_to_b', type: 'bool' },
              {
                ...
                type: { option: { defined: { generics: [], name: 'RemainingAccountsInfo' } } },
              },
            ],
    ...
    },
    {
      ...
      type: {
        fields: [
          {
            name: 'slices',
            type: { vec: { defined: { generics: [], name: 'RemainingAccountsSlice' } } },
          },
        ],
        kind: 'struct',
      },
    ...
    {
      name: 'AccountsType',
      type: { kind: 'enum', variants: [{ name: 'TransferHookA' }, { name: 'TransferHookB' }] },
    },
    {
      name: 'TokenLedger',
      type: {
